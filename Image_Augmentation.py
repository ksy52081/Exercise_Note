...
save_dir_noised = saveimg_path+'noised_'+targetimg_list[0] ##이미지 디렉토리
...
save_dir_blurred = saveimg_path+'blurred_'+targetimg_list[0] ##이미지 디렉토리
